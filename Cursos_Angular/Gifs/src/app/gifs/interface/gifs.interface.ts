// To parse this data:
//
//   import { Convert, Angular } from "./file";
//
//   const angular = Convert.toAngular(json);
//
...
export class Convert {
    public static toAngular(json: string): SearchGifsResponse {
        return cast(JSON.parse(json), r("Angular"));
    }

    public static angularToJson(value: SearchGifsResponse): string {
        return JSON.stringify(uncast(value, r("Angular")), null, 2);
    }
}
